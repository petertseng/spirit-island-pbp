...
urlpatterns = [
    ...
    path('game/<str:game_id>/setup_discard_pile/<str:type>', views.setup_discard_pile, name='setup_discard_pile'),
    ...
    path('game/<int:player_id>/setup_deck/<str:type>', views.setup_deck, name='setup_deck'),
    ...
    path('game/<int:player_id>/discard_scenario/<int:card_id>', views.discard_scenario, name='discard_scenario'),
